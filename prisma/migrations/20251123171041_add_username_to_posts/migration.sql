/*
  ...
  - Added the required column `username` to the `InstagramPost` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_InstagramPost" ("caption", "commentsCount", "createdAt", "hashtags", "id", "impressions", "likeCount", "mediaType", "mediaUrl", "permalink", "reach", "saved", "shop", "timestamp", "updatedAt") SELECT "caption", "commentsCount", "createdAt", "hashtags", "id", "impressions", "likeCount", "mediaType", "mediaUrl", "permalink", "reach", "saved", "shop", "timestamp", "updatedAt" FROM "InstagramPost";
